...
namespace Trif_DanielAlexandru_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Trif_DanielAlexandru_Lab2Context context, Book book) 
        {
        ...
        public void UpdateBookCategories(Trif_DanielAlexandru_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
